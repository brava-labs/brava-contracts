...
Change Date:          The earlier of (i) four years from the first public
                      ...
                      (ii) an earlier date announced by Brava Labs Ltd.
                      Each new published version of the Licensed Work has its
                      own Change Date, ensuring that upgrades reset the clock.
...
Effective on the Change Date for a given version, or the fourth anniversary of
the first publicly available distribution of that version under this License,
...
Source license. However, each version of the Licensed Work will eventually be
made available under the MIT License as stated in this License.
