...
/// @title UpgradeActionNoLog - An action for executing pre-approved upgrade transactions without logging
/// @notice This contract allows execution of pre-approved upgrade transactions through the sequence executor
/// @notice This is a temporary version with logging disabled to work around Logger limitations
/// @notice Found a vulnerability? Please contact security@bravalabs.xyz - we appreciate responsible disclosure and reward ethical hackers
contract UpgradeActionNoLog is ActionBase {
    struct Params {
    ...
    constructor(address _adminVault, address _logger, address _transactionRegistry) ActionBase(_adminVault, _logger) {
        require(_transactionRegistry != address(0), Errors.InvalidInput("UpgradeActionNoLog", "constructor"));
    ...
    function executeAction(bytes memory _callData, uint16 /*_strategyId*/) public payable override {
        ...
        // Logging is commented out due to Logger enum issue
