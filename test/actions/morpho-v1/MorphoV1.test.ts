...
describe('MorphoV1 tests', () => {
  ...
  before(async () => {
    ...
    fxUSDC = await getTypedContract<IERC4626>('IERC4626', tokenConfig.MORPHO_V1_fxUSDC.address);
    usualUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_USUALUSDC.address
    );
    gauntletUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_gtUSDCcore.address
    );
    re7USDT = await getTypedContract<IERC4626>('IERC4626', tokenConfig.MORPHO_V1_re7USDT.address);
    reUSDC = await getTypedContract<IERC4626>('IERC4626', tokenConfig.MORPHO_V1_reUSDC.address);
    steakUSDT = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_steakUSDT.address
    );
    steakUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_steakUSDC.address
    );
    gtUSDC = await getTypedContract<IERC4626>('IERC4626', tokenConfig.MORPHO_V1_gtUSDC.address);
    gtUSDT = await getTypedContract<IERC4626>('IERC4626', tokenConfig.MORPHO_V1_gtUSDT.address);
    smokehouseUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_smokehouseUSDC.address
    );
    gtDAIcore = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_gtDAIcore.address
    );
    coinshiftUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_coinshiftUSDC.address
    );
    steakhouseUSDC_RWA = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_steakhouseUSDC_RWA.address
    );
    mountDenaliUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_9S_MountDenali_USDC.address
    );
    summitsUSDC = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_9Summits_USDC.address
    );
    smokehouseUSDT = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_smokehouseUSDT.address
    );
    flagshipUSDT = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_flagshipUSDT.address
    );
    steakhouserUSD = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_steakhouserUSD.address
    );
    steakhousePYUSD = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_steakhousePYUSD.address
    );
    coinshiftUSDL = await getTypedContract<IERC4626>(
      'IERC4626',
      tokenConfig.MORPHO_V1_coinshiftUSDL.address
    );
    ...
    const morphoSupplyActionId = getBytes4(morphoV1SupplyAddress);
    const morphoWithdrawActionId = getBytes4(morphoV1WithdrawAddress);

    await adminVault.proposeAction(morphoSupplyActionId, morphoV1SupplyAddress);
    await adminVault.proposeAction(morphoWithdrawActionId, morphoV1WithdrawAddress);
    await adminVault.addAction(morphoSupplyActionId, morphoV1SupplyAddress);
    await adminVault.addAction(morphoWithdrawActionId, morphoV1WithdrawAddress);
  });
  ...
  describe('MorphoV1 Supply', () => {
    ...
    describe('General Supply Tests', () => {
      it('Should emit the correct log on deposit', async () => {
        ...
        const poolId: BytesLike = ethers
          .keccak256(tokenConfig.MORPHO_V1_fxUSDC.address)
          .slice(0, 10);
